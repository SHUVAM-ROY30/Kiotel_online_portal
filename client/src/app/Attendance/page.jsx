...
export default function ClockPage() {
  ...
  if (
    empData2.current_attendance &&
    empData2.current_attendance.clock_in &&
    !empData2.current_attendance.clock_out &&
    empData2.current_shift
  ) {
    setSelectedShift(empData2.current_shift);
    setClockInTime(empData2.current_attendance.clock_in);
    setIsClockedIn(true);
