...
// // Define your special role emails here
// const QA_EMAILS = [
//   "Zeelshah1649@gmail.com", // Replace with actual QA email(s)
//   "bhargavipuja13@gmail.com",
//   "m.dimple2506@gmail.com",
// ];

// const ADMIN_EMAILS = [
//   "arbaz.p@valianthotels.com", // Replace with actual Admin/Office_add email(s)
//   "vikash@valianthotels.com",
// ];

// const ALL_BYPASS_EMAILS = [...DIRECT_SHIFT_EMAILS, ...QA_EMAILS, ...ADMIN_EMAILS];
...
//         if (email !== ALLOWED_EMAIL && !ALL_BYPASS_EMAILS.includes(email)) {
//           router.push("/sign-in?error=access_denied");
//           return;
//         }
...
//         if (ALL_BYPASS_EMAILS.includes(email)) {
//           setIsDirectShiftUser(true);
//           setAccountNo(userData.unique_id);
...
//   const isQAUser = QA_EMAILS.includes(userEmail);
//   const isAdminUser = ADMIN_EMAILS.includes(userEmail);
//   const hideShiftFilters = isQAUser || isAdminUser;

//   const availableShifts = allShifts.filter((shift) => {
//     // Admin / Office_add sees ONLY the ADMIN shift (id = 42)
//     if (isAdminUser) {
//       return shift.id === 42 || shift.shift_name === 'ADMIN';
//     }
//     // QA users see ONLY QA SPECIAL shifts (category_id = 2)
//     if (isQAUser) {
...
//             {/* Mobile Filter Buttons - HIDE IF SPECIAL USER */}
//             {!hideShiftFilters && (
//               <div className="flex justify-center mb-6">
//                 <div className="inline-flex rounded-xl shadow-lg overflow-hidden border border-gray-200 w-full sm:w-auto">
//                   <button
...
//                 {/* Desktop Filter Buttons - HIDE IF SPECIAL USER */}
//                 {!hideShiftFilters && (
//                   <div className="flex justify-start mb-5 shrink-0">
//                     <div className="inline-flex rounded-xl shadow-sm overflow-hidden border border-gray-200">
//                       <button
...
// // Define your special role emails here
// const QA_EMAILS = [
//   "qa@kiotel.co", // Replace with actual QA email(s)
// ];

// const ADMIN_EMAILS = [
//   "office_add@kiotel.co", // Replace with actual Admin/Office_add email(s)
// ];
const QA_EMAILS = [
  "Zeelshah1649@gmail.com", // Replace with actual QA email(s)
  "bhargavipuja13@gmail.com",
...
export default function ClockPage() {
  ...
  const availableShifts = allShifts.filter((shift) => {
    ...
    // ═══════════════════════════════════════════════════════════
    // Normal logic for everyone else (Regular Users)
    // ═══════════════════════════════════════════════════════════
    // Explicitly hide Admin Shift & QA Special Shift (Category 2)
    if (shift.id === 42 || shift.shift_name === 'ADMIN') return false;
    if (shift.category_id === 2) return false;
