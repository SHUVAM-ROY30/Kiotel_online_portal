...
//   // UPDATED: Now receives the full 'task' object to access hk_task_id
...
//       // 1. Delete from External API first
//       if (task.hk_task_id) {
//         try {
...
//   // UPDATED: Calls External API to toggle `is_active` state
//   const handleToggleActive = async (e, task) => {
//     e.stopPropagation();
//     try {
//       const externalApiToken = process.env.NEXT_PUBLIC_EXTERNAL_API_TOKEN;

//       // 1. Toggle External API first
//       if (task.hk_task_id) {
//         try {
//           await axios.patch(`${API_EXT}api/v1/external/tasks/${task.hk_task_id}`, {
...
//                           </button>
//                           {/* UPDATED: Pass full `task` object to handleDeleteTask */}
//                           <button onClick={(e) => handleDeleteTask(e, task)} className="text-red-500 hover:text-red-700 transition" title="Delete Task">
