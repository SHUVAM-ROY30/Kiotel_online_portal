...
//         ticketState[ticket.task_id] || '',
//         ticketPriority[ticket.task_id] || '',
//         `${ticket.creator.fname} ${ticket.creator.lname}`,
//         allAssignedUsers[ticket.task_id]?.map(u => `${u.fname} ${u.lname}`).join(', ') || 'Unassigned',
//         ticketDueDate[ticket.task_id] ? new Date(ticketDueDate[ticket.task_id]).toLocaleDateString() : 'No due date',
//         ticket.task_tags || ''
//       ])
...
//                 }`}
//                 title={selectedCount === 0 ? "Select tasks to export" : "Export selected tasks to PDF"}
//               >
