...
//   isLoading,
//   photoType, // 'clock_in' or 'clock_out'
//   onSubmit // ← NEW PROP added to handle submission directly from the photo overlay
// }) => {
//   const videoRef = useRef(null);
//   const canvasRef = useRef(null);
//   const [stream, setStream] = useState(null);
...
//           <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
//             {cameraError ? (
//               <div className="w-full aspect-[4/3] flex flex-col items-center justify-center text-center p-8">
//                 <div className="w-20 h-20 mb-6 rounded-full bg-red-50 flex items-center justify-center">
//                   <svg className="w-10 h-10 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
//                   </svg>
...
//             ) : (
//               <>
//                 {/* Video Feed - Changed to 4/3 aspect ratio to reduce vertical height */}
//                 <div className="relative">
//                   <video
//                     ref={videoRef}
//                     autoPlay
//                     playsInline
//                     muted
//                     className={`w-full object-cover aspect-[4/3] ${facingMode === 'user' ? 'scale-x-[-1]' : ''}`}
//                   />
...
//             {/* Gradient Overlay to make bottom buttons visible */}
//             <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/20 pointer-events-none"></div>
            
//             {/* Success Badge */}
//             <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-green-500/90 backdrop-blur-sm text-white px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
//               <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
//                 <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
//               </svg>
//               <span className="text-sm font-semibold">Photo Captured</span>
...
//             {/* Retake & Submit Buttons Overlay */}
//             <div className="absolute bottom-6 left-0 right-0 flex justify-center items-center gap-4 px-6 w-full">
//               <button
//                 onClick={retakePhoto}
//                 disabled={isLoading}
//                 className="flex-1 bg-white/90 backdrop-blur-md hover:bg-white text-gray-800 px-4 py-3 rounded-xl font-bold shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
//               >
//                 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
//                 </svg>
...
//                   onClick={onSubmit}
//                   disabled={isLoading}
//                   className={`flex-1 bg-gradient-to-r ${actionColor} hover:shadow-2xl text-white font-bold px-4 py-3 rounded-xl shadow-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2`}
//                 >
//                   {isLoading ? (
//                     <>
...
//       {/* Capture Button (Only shows when camera is active) */}
