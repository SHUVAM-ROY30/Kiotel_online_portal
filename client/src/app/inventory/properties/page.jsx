...
export default function PropertiesList() {
  ...
  const handleDownloadTemplate = async () => {
    try {
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/inventory/properties/template`,
        {
          withCredentials: true,
          headers: {
            "x-user-id": user.id,
      ...
      link.href = url;
      link.setAttribute('download', 'properties_template.xlsx');
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/inventory/properties/import`,
        formData,
        {
          withCredentials: true,
          headers: {
      ...
      setError(err.response?.data?.message || "Failed to import properties.");
    } finally {
      setImporting(false);
    }
  };
  ...
  return (
    <InventoryLayout title="Properties" subtitle={`${filtered.length} properties found`}>
      <div className="list-toolbar">
        ...
        {can("create") && (
          <>
            ...
            <Link href="/inventory/add-property" className="list-btn-primary">
      ...
      {loading ? (
        ...
        <div className="list-empty">
          ...
          <div className="list-empty-text">No properties found</div>
          <div className="list-empty-sub">Try adjusting your search or add a new property</div>
        </div>
      ) : (
        <div className="list-grid">
              ...
              <Link href={`/inventory/property/${property.id}`} style={{ textDecoration: "none", color: "inherit", display: "block" }}>
                <div className="list-item-body">
                  ...
                  <div className="list-item-updated">
                    Created {property.created_at ? new Date(property.created_at).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "2-digit" }) : "—"}
                  </div>
                </div>
              </Link>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ background: "#f0f9ff", border: "1px solid #bae6fd", borderRadius: 8, padding: 16, marginBottom: 16 }}>
                ...
                <ol style={{ margin: 0, paddingLeft: 20, fontSize: 13, color: "#0c4a6e", lineHeight: 1.6 }}>
                  ...
                  <li>Fill in property details (Code and Name are required)</li>
              ...
              >
                ...
                Download Template (properties_template.xlsx)
              </button>
