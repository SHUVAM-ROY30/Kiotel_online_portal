...
//         { withCredentials: true }
//       );
//       // Update local state (we don't have a separate state for due dates, so we'll just refresh the data)
//       // In a real app, you might want to maintain a separate state for due dates
...
//                               <input
//                                 type="date"
//                                 defaultValue={ticket.due_date ? new Date(ticket.due_date).toISOString().split('T')[0] : ''}
//                                 onChange={(e) => {
...
//                               />
//                               <button
//                                 onClick={() => handleDueDateChange(ticket.task_id, ticket.due_date ? new Date(ticket.due_date).toISOString().split('T')[0] : '')}
//                                 className="text-green-600 hover:text-green-800"
//                               >
//                                 <FaSave className="h-3 w-3" />
//                               </button>
...
//                                   ticket.due_date && new Date(ticket.due_date) < new Date() ? 'bg-red-100 text-red-800 border border-red-200' : 'bg-gray-100 text-gray-800 border border-gray-200'
