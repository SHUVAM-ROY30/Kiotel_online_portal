...
//   // Fetch employee leave balances from the backend
//   useEffect(() => {
//     const fetchLeaveBalances = async () => {
//       try {
//         const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/admin/leave-balances`);
...
//   return (
//     <div>
//       <h2 className="text-xl font-bold text-blue-700 mb-4">Employee Leave Balances</h2>
//       <table className="w-full border-collapse border border-blue-300">
//         <thead>
//           <tr className="bg-blue-100 text-blue-800">
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Unique_id</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Name</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Annual Leave</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Sick Leave</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Casual Leave</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Other Leave</th>
//           </tr>
//         </thead>
//         <tbody>
//           {employees.map((employee) => (
//             <tr key={employee.unique_id} className="hover:bg-blue-50 transition duration-200">
...
//               <td className="border border-blue-300 px-4 py-3 text-gray-800">{employee.annual_leave}</td>
//               <td className="border border-blue-300 px-4 py-3 text-gray-800">{employee.sick_leave}</td>
//               <td className="border border-blue-300 px-4 py-3 text-gray-800">{employee.casual_leave}</td>
//               <td className="border border-blue-300 px-4 py-3 text-gray-800">{employee.other_leave}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
...
// import axios from "axios";
// import { useEffect, useState } from "react";
// import EditLeaveForm from "./EditLeaveForm"; // Import the reusable form component
...
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Unique_id</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Name</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Paid Leave</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Festive Leave</th>
//             <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Casual Leave</th>
//             {/* <th className="border border-blue-300 px-4 py-3 font-semibold text-left">Other Leave</th> */}
...
//       {/* Render the EditLeaveForm when an employee is selected for editing */}
//       {editingEmployee && (
//         <EditLeaveForm
//           employee={editingEmployee}
//           onClose={() => setEditingEmployee(null)} // Close the form
//           onUpdate={(updatedData) => {
//             // Update the employee's leave balances in the state
//             setEmployees((prevEmployees) =>
//               prevEmployees.map((emp) => (emp.unique_id === updatedData.unique_id ? { ...emp, ...updatedData } : emp))
//             );
//             setEditingEmployee(null); // Close the form after update
//           }}
//         />
//       )}
//     </div>
...
// import { useEffect, useState } from "react";
// import EditLeaveForm from "./EditLeaveForm";
// import AddLeavesModal from "./AddLeavesModal"; // Import the reusable component
...
//   const [error, setError] = useState("");
//   const [editingEmployee, setEditingEmployee] = useState(null);
//   const [showAddLeavesModal, setShowAddLeavesModal] = useState(false); // State for modal visibility
