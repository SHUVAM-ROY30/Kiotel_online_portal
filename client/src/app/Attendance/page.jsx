...
//               </div>
//               <h2 className="text-2xl font-bold text-gray-900 mb-2">Clock In / Clock Out</h2>
//               <p className="text-gray-600">Enter your Employee ID to continue</p>
//             </div>

//             <form onSubmit={handleIdSubmit} className="space-y-6">
//               <div>
//                 <label htmlFor="account_no" className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
...
//                   <form onSubmit={handleIdSubmit} className="space-y-6">
//                     <div>
//                       <label htmlFor="account_no_desktop" className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
//                         <FaIdCard className="text-blue-600" />
//                         Employee ID
//                       </label>
//                       <input
...
//                 <span className="text-white text-3xl font-bold">{employee?.name?.charAt(0) || '?'}</span>
//               </div>
//               <h2 className="text-2xl font-bold text-gray-900 mb-1">{employee?.name || 'Employee'}</h2>
...
//                   <p className="text-gray-500 font-medium">No {shiftCategory} shifts available</p>
//                 </div>
//               ) : (
...
//                       <div className="flex justify-between items-center">
//                         <div>
//                           <h4 className="font-bold text-gray-900 mb-1">{shift.shift_name}</h4>
...
//                     <span className="text-6xl font-bold">{employee?.name?.charAt(0) || '?'}</span>
//                   </div>
//                   <h2 className="text-3xl font-bold mb-2">{employee?.name || 'Employee'}</h2>
//                   <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 rounded-lg backdrop-blur-sm">
//                     <FaIdCard />
//                     <span className="font-semibold">ID: {employee?.unique_id || 'N/A'}</span>
//                   </div>
//                 </div>
//               </div>
...
//                         <p className="text-gray-500 font-medium text-lg">No {shiftCategory} shifts available</p>
//                       </div>
//                     ) : (
...
//                             <div className="flex justify-between items-center">
//                               <div>
//                                 <h4 className="font-bold text-gray-900 mb-1 text-lg">{shift.shift_name}</h4>
//                                 <p className="text-sm text-gray-600 flex items-center gap-2">
//                                   <FaClock className="text-blue-600" />
//                                   {shift.start_time} - {shift.end_time}
//                                 </p>
...
//                 <FaClock className="text-blue-600" />
//                 <span className="font-semibold text-gray-900">{selectedShift?.shift_name || 'No Shift'}</span>
//                 <span className="text-gray-600">•</span>
//                 <span className="text-sm text-gray-600">{selectedShift?.start_time} - {selectedShift?.end_time}</span>
//               </div>
//             </div>

//             {message && (
//               <div className={`text-center mb-6 p-4 rounded-xl border-2 font-semibold ${
//                 message.includes('Clocked out') ? 'bg-blue-50 border-blue-200 text-blue-800' :
//                 message.includes('Clocked in') ? 'bg-green-50 border-green-200 text-green-800' :
...
//                   </div>
//                   <span className="font-bold text-gray-900">{formatTime(clockInTime)}</span>
//                 </div>
...
//                   </div>
//                   <span className="font-bold text-gray-900">{formatTime(clockOutTime)}</span>
//                 </div>
//               </div>
//             )}
...
//                       <span className="text-6xl font-bold">{employee?.name?.charAt(0) || '?'}</span>
//                     </div>
//                     <h2 className="text-2xl font-bold mb-2">{employee?.name || 'Employee'}</h2>
...
//                     <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 rounded-lg backdrop-blur-sm">
//                       <FaClock />
//                       <span className="font-semibold text-sm">{selectedShift?.shift_name || 'No Shift'}</span>
//                     </div>
...
//                   {message && (
//                     <div className={`p-4 rounded-xl font-semibold text-center mb-6 ${
//                       message.includes('Clocked out') ? 'bg-white/20 backdrop-blur-sm' :
//                       message.includes('Clocked in') ? 'bg-green-500/30 backdrop-blur-sm' :
...
//                           <span className="font-medium">Clock In:</span>
//                         </div>
//                         <span className="font-bold text-lg">{formatTime(clockInTime)}</span>
//                       </div>
//                       <div className="flex items-center justify-between">
//                         <div className="flex items-center gap-2">
//                           <FaSignOutAlt />
//                           <span className="font-medium">Clock Out:</span>
//                         </div>
//                         <span className="font-bold text-lg">{formatTime(clockOutTime)}</span>
//                       </div>
//                     </div>
//                   )}
//                 </div>
...
//                         {photoCaptured ? 'Photo captured successfully' : 'Take your photo to continue'}
//                       </p>
//                     </div>
