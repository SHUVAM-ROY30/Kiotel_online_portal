...
//     if (!lastName) validationErrors.lastName = "Last name is required";
//     if (!dob) validationErrors.dob = "Date of birth is required";
//     if (!identityCodeAlpha || !identityCodeNumeric) validationErrors.identityCode = "Identity Code is required";
//     if (!contactNumber) validationErrors.contactNumber = "Contact number is required";
//     if (!role) validationErrors.role = "Role is required";
//     return validationErrors;
//   };
...
//           <div className="grid grid-cols-2 gap-6">
//             <div>
//               <label className="block text-sm font-medium text-gray-700">Identity Code</label>
//               <div className="flex space-x-2">
//                 <input
//                   type="text"
//                   maxLength={1}
//                   value={identityCodeAlpha}
//                   onChange={(e) => setIdentityCodeAlpha(e.target.value)}
//                   placeholder="Letter"
//                   className={`w-16 mt-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${
...
//               </div>
//               {errors.identityCode && (
//                 <p className="text-red-600 text-sm">{errors.identityCode}</p>
//               )}
//             </div>
//           </div>
...
//                   onChange={(e) => setConfirmPassword(e.target.value)}
//                   className={`w-full mt-2 px-4 py-2 border ${
//                     password === confirmPassword ? "border-gray-300" : "border-red-500"
//                   } rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500`}
//                 />
//                 <button
//                   type="button"
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                maxLength={1}
                value={identityCodeAlpha}
                onChange={(e) => setIdentityCodeAlpha(e.target.value.toUpperCase())}
                placeholder="e.g., S"
                className={`w-16 mt-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors.identityCode ? "border-red-500" : ""
                }`}
              />
              {errors.identityCode && (
                <p className="text-red-600 text-sm mt-1">{errors.identityCode}</p>
              )}
            </div>
            <div>
