                              ...
                              <td className="px-2 sm:px-3 py-2">
                                {row.is_first_shift ? (
                                  ...
                                  <div className="flex items-center pl-3 mt-1 relative">
                                     <svg className="w-4 h-4 mr-2 text-blue-400 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 4v7a2 2 0 002 2h4m0 0l-2-2m2 2l-2 2" />
                                     </svg>
