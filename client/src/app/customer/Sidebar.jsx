...
//         <label className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-3 block">Context: Active Property</label>
...
//           </div>
//         ) : (
//           <div className="text-sm text-gray-500 italic p-3 bg-white border border-gray-200 rounded-xl shadow-sm">No properties found</div>
//         )}
//       </div>

//       {/* Sidebar Links (Scrollable if they exceed height) */}
//       <div className="flex-1 overflow-y-auto py-5 px-4 space-y-8">
        
//         {/* Global Modules (Common to all) */}
//         <div>
...
//                 className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${pathname === '/tasks' ? 'bg-blue-600 text-white shadow-md shadow-blue-500/20' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-700'}`}
//               >
...
//         <div>
//           <h3 className="px-3 text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-3">Property Specific</h3>
//           <ul className="space-y-1.5">
//             <li>
//               <button 
//                 onClick={() => router.push('/customer/dashboard')}
//                 className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${pathname.includes('dashboard') ? 'bg-blue-600 text-white shadow-md shadow-blue-500/20' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-700'}`}
//               >
...
//                 className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-gray-600 hover:bg-blue-50 hover:text-blue-700 transition-all disabled:opacity-50 disabled:hover:bg-transparent"
//               >
...
//             <li>
//               <button 
//                 onClick={() => { if (propertyLinks?.shared_folder_url) window.open(propertyLinks.shared_folder_url, '_blank', 'noopener,noreferrer'); }}
//                 disabled={!propertyLinks?.shared_folder_url}
//                 className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-semibold text-gray-600 hover:bg-blue-50 hover:text-blue-700 transition-all disabled:opacity-50 disabled:hover:bg-transparent group"
//               >
...
//                   <svg className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
//                 )}
//               </button>
//             </li>
//             <li>
//               <button 
//                 onClick={() => { if (propertyLinks?.invoice_portal_url) window.open(propertyLinks.invoice_portal_url, '_blank', 'noopener,noreferrer'); }}
...
//         {/* Forms Section */}
//         <div>
//           <h3 className="px-3 text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-3">Forms</h3>
//           <ul className="space-y-1.5">
//             <li>
//               <button 
//                 onClick={() => router.push('/customer/forms/property')}
//                 disabled={!selectedProperty}
//                 className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all disabled:opacity-50 disabled:hover:bg-transparent ${pathname.includes('forms/property') ? 'bg-blue-600 text-white shadow-md shadow-blue-500/20' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-700'}`}
//               >
...
//                 disabled={!selectedProperty}
//                 className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all disabled:opacity-50 disabled:hover:bg-transparent ${pathname.includes('forms/equipment') ? 'bg-blue-600 text-white shadow-md shadow-blue-500/20' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-700'}`}
//               >
