                  ...
                  {records.map((record, index) => {
                    ...
                    return (
                      <tr key={record.id || index} className={`border-b border-gray-100 transition-colors ${isSunday ? "bg-red-50/50" : index % 2 === 0 ? "bg-white" : "bg-gray-50/50"} hover:bg-blue-50/50`}>
                        <td className="px-5 py-3.5 font-medium text-gray-900">{record.attendance_date}</td>
                        <td className={`px-5 py-3.5 font-medium ${isSunday ? "text-red-500" : "text-gray-600"}`}>{dayName}</td>
                        <td className="px-5 py-3.5 text-gray-700">{record.shift_name}</td>
                        <td className="px-5 py-3.5 text-center">
                        ...
                        <td className="px-5 py-3.5 text-center font-semibold text-gray-800">{record.working_hours?.display || "—"}</td>
                        <td className="px-5 py-3.5 text-center">
                          {record.status === "completed" ? (
