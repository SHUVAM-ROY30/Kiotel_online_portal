...
// /* ────────── Highlight / Change-request Side Panel ────────── */
...
//                   style={{ borderColor: h.color || "#EAB308", backgroundColor: (h.bg_color || "#FEF08A") + "33" }}
//                 >
...
//                 <div key={cr._id} className="p-3 rounded-xl border border-orange-200 bg-orange-50/50">
...
//                       <button
//                         onClick={() => onApproveChangeRequest(cr._id, "approved")}
...
//                       </button>
//                       <button
//                         onClick={() => onApproveChangeRequest(cr._id, "rejected")}
...
//         setPolicyId(res.data.policy._id);
//       }
//     } catch (err) {
...
//       fetchHistory();
//     }
//   }, [userRole, fetchPolicy, fetchHighlights, fetchChangeRequests, fetchHistory]);

//   /* ── set editor content when policy loads / editing starts ── */
//   useEffect(() => {
...
//     const text = getSelectedText();
//     if (!text) {
//       alert("Please select some text to request a change.");
//       return;
//     }
//     setSelectedText(text);
...
//   /* ── build highlighted content for display ── */
...
//                 {/* Highlight button — visible to all (non-client) users */}
//                 <button
