...
//           <div className="relative max-w-2xl w-full bg-white rounded-2xl overflow-hidden shadow-2xl animate-slideDown">
//             {/* Close Button */}
//             <button 
...
//               <button 
//                 onClick={() => setShowAnnouncement(false)}
//                 className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-bold rounded-xl shadow-md transition-all"
//               >
