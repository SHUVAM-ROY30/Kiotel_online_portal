...
//   const [isDisclaimerAgreed, setIsDisclaimerAgreed] = useState(false); // State for disclaimer agreement
...
//     try {
//       const response = await axios.get(
//         `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/check-overlaps`,
//         {
//           params: {
...
//         `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/leave-requests`,
//         {
//           unique_id: uniqueId,
...
//   //               If leave is requested within 3 hours or less before the scheduled shift, it will result in a deduction of 2 days' pay.
//   //             </p>
//   //           </div>
...
//           </svg>
//         </button>
//         <h2 className="text-xl font-bold text-blue-700 mb-4">Request Leave - {employeeName}</h2>
