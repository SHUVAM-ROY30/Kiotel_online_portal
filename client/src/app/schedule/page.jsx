...
//           <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl mr-4 flex items-center justify-center text-white font-bold text-lg shadow-md">
...
//           ? schedRes.data
//           : schedRes.data.filter(s => s.status === 'LIVE');
...
//             bgColor = 'bg-yellow-100'; // Light pink background
//             borderColor = 'border-yellow-300';
//             textColor = 'text-yellow-800'; // Pink text
//             break;
//           case 'UNAVAILABLE':
//             statusText = 'Week OFF';
...
//   // ✅ FIXED: Validate dateStr before use
...
//           {/* Sidebar */}
//           <div className="lg:w-72 bg-white rounded-2xl shadow-xl border border-slate-200 p-5 h-fit">
...
//                   className="w-full p-3 border border-slate-300 rounded-xl text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//                 />
//               </div>
...
//                       ? "Please select or publish a schedule."
