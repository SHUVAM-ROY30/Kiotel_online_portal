...
//           lg:translate-x-0
//         `}>
//           <div className="flex-1 overflow-y-auto lg:overflow-visible overscroll-contain p-4 pt-16 lg:p-4"></div>
...
//     // Show to Admin (role 1) always, or HR (role 5) only when schedule is DRAFT
