...
//   const [unreadCount, setUnreadCount] = useState(0); // Total unread for floating red badge
//   const [unreadPerUser, setUnreadPerUser] = useState([]); // WhatsApp-style badge per user
...
//   // 1. Session & Initial Unread Fetch
//   useEffect(() => {
//     let isMounted = true;
...
//   }, [userUniqueID, userFname, SOCKET_URL]);
