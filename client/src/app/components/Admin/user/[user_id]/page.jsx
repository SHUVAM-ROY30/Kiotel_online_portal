...
//           role_id: userData.role_id || "", // Initialize with user's current role_id
//         });
...
//       ...formData,
//       dob: formattedDob,
//       role_id: roles.find(role => role.name === formData.role_id)?.role_id // Get role_id based on the selected role name
//     };
//     const newErrors = {};
...
//             <select
//               name="role_id"
//               value={roles.find(role => role.role_id === formData.role_id)?.name || ""} // Set the dropdown to show the current user's role
//               onChange={handleChange}
//               required
//               className={`w-full mt-2 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${
...
//                 <option key={roleOption.role_id} value={roleOption.name}> 
//                   {roleOption.name}
//                 </option>
//               ))}
//             </select>
...
//         <button
//           type="submit"
//           className={`mt-6 w-full py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 ${loading ? "opacity-50 cursor-not-allowed" : ""
//             }`}
//           disabled={loading}
//         >
