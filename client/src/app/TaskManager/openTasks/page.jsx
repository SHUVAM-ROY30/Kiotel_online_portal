...
const OpenedTickets = () => {
  ...
  const handlePriorityChange = async (ticketId, priorityId) => {
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/update_ticket_priority`, {
        ticket_id: ticketId,
        priority_id: priorityId,
      });
      setTicketPriority(prevState => ({ ...prevState, [ticketId]: { priority_id: priorityId } }));
