...
//     try {
//       const res = await axios.get(`${API_BASE_URL}/careers/internal-applications/me/${uniqueId}`);
...
//     try {
//       const res = await axios.get(`${API_BASE_URL}/careers/internal-positions`);
...
//       await axios.post(`${API_BASE_URL}/careers/internal-applications`, payload);
