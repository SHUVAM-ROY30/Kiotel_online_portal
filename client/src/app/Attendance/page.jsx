...
// // import FaceScan from "./FaceScan";         // ← NEW IMPORT
// // import FaceRegister from "./FaceRegister"; // ← NEW IMPORT
// // import {
// //   FaUser,
// //   FaClock,
// //   FaCheckCircle,
...
// //   // ─── CHANGED: Default step is now "face_scan" instead of "id" ───
...
// //   // Auto-advance to clock-out if they already have an open session today
// //   if (isNewFaceUser) {
// //   // Face registration always takes priority — clock-out happens after
...
// // ) {
// //   // Known face user with open session → skip to clock-out
...
// //               setStep("face_scan"); // ← CHANGED from "id"
// //             }
// //           } catch (err) {
...
// //           }
// //         } else {
// //           // ─── CHANGED: Start with face scan instead of ID entry ───
// //           setStep("face_scan");
// //         }
...
// //     // Auto-select shift and skip to action if employee has an open clock-in today
// //     if (
// //       empData.current_attendance &&
// //       empData.current_attendance.clock_in &&
// //       !empData.current_attendance.clock_out &&
...
// //   // ─── NEW: Handle face scan no match → show ID entry ───
// //   const handleFaceNoMatch = () => {
// //     setIsNewFaceUser(true); // Flag to trigger face registration later
// //     setStep("id");
// //   };

// //   // ─── NEW: Handle face scan error ───
// //   const handleFaceScanError = (error) => {
// //     console.error("Face scan error:", error);
// //     setStep("id"); // Fallback to manual ID entry
// //   };
...
// //   //     // ─── NEW: If this is a new face user, show face registration ───
// //   //     if (isNewFaceUser) {
// //   //       setShowFaceRegister(true);
// //   //       setStep("face_register");
// //   //     } else {
...
// // //       setMessage(`Currently clocked in. Ready to clock out.`);
// // //       setStep("action");
// // //     } else if (isNewFaceUser) {
// // //       // New face user with no open session → register face first
// // //       setShowFaceRegister(true);
// // //       setStep("face_register");
// // //     } else {
// // //       setStep("shift");
...
// // //   }
// // // };
// //   // ─── NEW: Handle face registration complete ───
...
// //     // forceRegister = true means they explicitly want face registration
...
// //   // After registration, check if they have an open clock-in to handle
// //   if (
...
// //   // // ─── NEW: Handle face registration skip ───
...
// //   // ... handleConfirmShift, handlePhotoCapture, handlePhotoRetake, handleSubmitPhoto 
// //   // ... remain EXACTLY the same as your current code — no changes needed
// //   // ... (keep all of those functions as-is)
...
// //     } else {
// //       // ─── CHANGED: Reset to face_scan instead of "id" ───
// //       setStep("face_scan");
// //       setAccountNo("");
// //       setEmployee(null);
// //       setSelectedShift(null);
...
// //   // ═══════════════════════════════════════════════════════════
// //   // NEW STEP: Face Scan (First screen)
// //   // ═══════════════════════════════════════════════════════════
...
// //                   <h1 className="text-5xl lg:text-6xl font-black mb-4">KIOTEL</h1>
...
// //   // ═══════════════════════════════════════════════════════════
// //   // STEP: ID Entry (Fallback when face not recognized)
// //   // Only change: added "Back to Face Scan" button
// //   // ═══════════════════════════════════════════════════════════
...
// //               </div>
// //               <h2 className="text-2xl font-bold text-gray-900 mb-2">
// //                 {isNewFaceUser ? "Face Not Recognized" : "Clock In / Clock Out"}
// //               </h2>
// //               <p className="text-gray-600">
// //                 {isNewFaceUser 
// //                   ? "Enter your Employee ID to register your face" 
// //                   : "Enter your Employee ID to continue"}
// //               </p>
// //             </div>

// //             {/* ─── NEW: Info banner for new face users ─── */}
// //             {isNewFaceUser && (
...
// //                 ) : (
// //                   <>
// //                     {isNewFaceUser ? "Continue & Register Face" : "Continue"}
...
// //                   <h2 className="text-3xl font-bold mb-4">Attendance System</h2>
// //                   <p className="text-lg text-blue-100 max-w-md">
// //                     {isNewFaceUser ? "Register your face for faster clock-ins" : "Clock in/out Module"}
// //                   </p>
// //                 </div>
// //               </div>
...
// //                       {isNewFaceUser ? "Face Not Recognized" : "Welcome Back"}
// //                     </h2>
// //                     <p className="text-gray-600">
// //                       {isNewFaceUser 
// //                         ? "Enter your ID to register your face" 
// //                         : "Enter your Employee ID to continue"}
// //                     </p>
// //                   </div>
...
// //   // ═══════════════════════════════════════════════════════════
// //   // NEW STEP: Face Registration (for first-time employees)
// //   // ═══════════════════════════════════════════════════════════
...
// //                     </span>
// //                   </div>
// //                   <div className="mt-8 bg-white/20 backdrop-blur-sm rounded-xl p-5">
...
// //   // ═══════════════════════════════════════════════════════════
// //   // EXISTING STEPS: shift, action — NO CHANGES NEEDED
// //   // Keep your existing code for these steps exactly as-is
// //   // ═══════════════════════════════════════════════════════════
...
//               {/* Left Panel - Branding */}
//               <div className="bg-gradient-to-br from-blue-600 to-blue-500 p-8 lg:p-12 flex flex-col items-center justify-center text-white relative overflow-hidden h-full">
//                 <div className="absolute top-10 right-10 w-32 h-32 bg-white/10 rounded-full"></div>
//                 <div className="absolute bottom-10 left-10 w-24 h-24 bg-white/10 rounded-full"></div>
//                 <div className="relative z-10 text-center w-full">
//                   <h1 className="text-5xl lg:text-6xl font-black mb-4">KIOTEL</h1>
...
//               {/* Left Panel */}
//               <div className="lg:col-span-2 bg-gradient-to-br from-blue-600 to-blue-500 p-8 flex flex-col items-center justify-center text-white relative overflow-hidden h-full">
//                 <div className="absolute top-10 right-10 w-32 h-32 bg-white/10 rounded-full"></div>
//                 <div className="absolute bottom-10 left-10 w-24 h-24 bg-white/10 rounded-full"></div>
//                 <div className="relative z-10 text-center w-full">
//                   <h1 className="text-3xl font-black mb-2">KIOTEL</h1>
...
//   // ═══════════════════════════════════════════════════════════
//   // STEP: Shift (Fixed Scrolling and Layout stretching)
//   // ═══════════════════════════════════════════════════════════
//   if (step === "shift") {
//     return (
//       <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 flex items-center justify-center p-4 relative overflow-hidden">
...
//         {/* Mobile Layout (Reverted to natural sizing with max-h scrolling) */}
//         <div className="relative z-10 w-full max-w-md lg:hidden">
//           <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl p-6 sm:p-8 border border-gray-200/50">
//             <div className="text-center mb-6">
//               <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
...
//                             }}
//                             disabled={loading}
//                             className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold py-3 rounded-xl transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
//                           >
//                             {loading ? "Checking..." : "Confirm & Continue"}
//                           </button>
//                         </div>
...
//         {/* Desktop Layout (Fixed Grid Stretch with min-h-0) */}
...
//             {/* The min-h-0 here is critical to stop the grid from growing infinitely */}
//             <div className="grid lg:grid-cols-5 gap-0 w-full h-full min-h-0">
...
//               {/* Added min-h-0 so the flex container knows its bounds */}
...
//                 {/* Added min-h-0 to let this shrink and trigger the scrollbar naturally */}
...
//                                 }}
//                                 disabled={loading}
//                                 className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold py-3 rounded-xl transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-lg"
//                               >
//                                 {loading ? "Checking..." : "Confirm & Continue"}
//                               </button>
//                             </div>
...
//                 {message && (
//                   <div className="mb-6 p-4 bg-blue-50 border border-blue-200 text-blue-700 rounded-xl text-sm font-medium shrink-0">
//                     {message}
//                   </div>
//                 )}
...
//           <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden flex h-full">
//             <div className="grid lg:grid-cols-5 gap-0 w-full h-full min-h-0">
//               <div className="lg:col-span-2 bg-gradient-to-br from-blue-600 to-blue-500 p-8 flex flex-col text-white relative overflow-hidden h-full">
//                 <div className="absolute top-10 right-10 w-32 h-32 bg-white/10 rounded-full"></div>
//                 <div className="absolute bottom-10 left-10 w-24 h-24 bg-white/10 rounded-full"></div>
...
//                 {message && (
//                   <div className="mb-4 p-3 bg-blue-50 border border-blue-200 text-blue-700 rounded-xl text-sm font-medium shrink-0">
//                     {message}
//                   </div>
//                 )}
...
//                   isLoading={loading}
//                   photoType={photoType}
//                   onSubmit={handleSubmitPhoto} // Submit logic is now inside PhotoCapture
//                 />
//               )}
//             </div>
...
//             {/* Submit button removed from bottom bar, only Reset remains */}
//             <div className="flex gap-3">
//               <button
//                 type="button"
//                 onClick={resetSession}
...
//         setPhotoCaptured(true);
//         // Automatically return to first page after 2.5s
//         setTimeout(() => {
//           resetSession();
//         }, 2500);
//       } else {
...
export default function ClockPage() {
  ...
  const handlePhotoCapture = (dataUrl) => {
    setPhotoData(dataUrl);
    // Submit immediately upon capture
